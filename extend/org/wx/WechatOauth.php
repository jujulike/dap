...
class WechatOauth
{
    private $wechat_config = [
        'appid'=>'wx50acac863d125801',
        'appsecret' =>'653f45ee40a39283b78fdb991d2024f1',
    ];
    ...
    public function wechatConfig() {
       // $wechat_config = array_merge($this->wechat_config,config('wechat.oauth'));return $wechat_config;
    }
    /**
     * 获取openid
     * @return string|mixed
