...
return [
	...
	'view_replace_str'  =>  [ 
        '__ROOT__'   => __ROOT__,
	    '__PUBLIC__' => __ROOT__.'/zhiing', 
		'__STATIC__' => __ROOT__.'/zhiing/static',
		'__ADDONS__' => __ROOT__.'/zhiing/admin/addons',
		'__IMG__'    => __ROOT__.'/zhiing/admin/images',
		'__CSS__'    => __ROOT__.'/zhiing/admin/css',
		'__JS__'     => __ROOT__.'/zhiing/admin/js',
	],
    // +----------------------------------------------------------------------
    // | 会话设置
    // +---------------------------------------------------------------------- 
